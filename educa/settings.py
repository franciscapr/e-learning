...
SECRET_KEY = 'django-insecure-wm#@!)z8vktiz$rn9nyni%!1hepj#i(0er&)9sqwh7tf$3a!hf'
...
# Usamos el backend de cachè de RedisCache
CACHES = {
    'default': {
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [("127.0.0.1", 6379)],  # Dirección y puerto de Redis
        },
    },
}