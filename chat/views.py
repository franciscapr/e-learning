...
def course_chat_room(request, course_id):    # Recibe el paràmetro obligatorio course_id para recuperar el curso con el id proporcionado.
    ...
    return render(request, 'chat/room.html', {'course': course})    # Si el curso con el ID dado si existe y el usuario esta inscrito en el , se renderiza la plantilla chat/room.html